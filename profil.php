...
<nav class="navbar">
    <div class="navbar-container">
        ...
        <div class="nav-links">
            ...
            <a href="all_video.php" class="nav-link">
                Recettes
            </a>
...
<div class="container">
    <div class="profile-card">
        ...
        <!-- User Name -->
        <p class="username"><?php echo htmlspecialchars($username); ?></p><br>
...
<div class="row">
    ...
    $lignes = []; // Initialisation de la variable à l'extérieur du bloc try
    ...
    try {
        ...
        if ($stmt->rowCount() > 0) {
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                // Ajouter des boutons CRUD
                echo '<div class="crud-buttons">';
                echo '<a href="edit_video.php?id=' . $videoId . '" class="btn-edit">Modifier</a>';
                echo '<a href="delete_video.php?id=' . $videoId . '" class="btn-delete" onclick="return confirm(\'Êtes-vous sûr de vouloir supprimer cette vidéo ?\');">Supprimer</a>';
                echo '</div>';
            }
        }
    ...
    if (empty($lignes)) {
        echo "<p>Aucune vidéo n'a été trouvée.</p>";
    }
    ?>
</div>
</body>
